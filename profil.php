		...
		<div class="col-lg-8">
			<div style="border: 0px solid; border-radius: 10px;" class="MainNews">
				...
				<div style="border: 0px solid; border-radius: 10px;" class="NewsATT">
					...
					<p>
						<center>
							<img src="https://minotar.net/cube/<?php echo $_SESSION['user_nick']; ?>/100.png">
							<h3>Kullanıcı Adı: <?php echo $_SESSION['user_nick']; ?></h3>
							<h3>Krediniz: <?php echo $kullanici['kredi']; ?> TL</h3>
<h3>Yetkiniz: <?php if ($kullanici['yetki']==0) {?>Üye<?php } ?><?php if ($kullanici['yetki']==2) {?>Cezalı<?php } ?><?php if ($kullanici['yetki']==1) {?>Admin<?php } ?></h3>
<br>
							<a href="sifredegistir.php"><button class="btn btn-alert">Şifre Değiştir</button></a>
						</center>
					</p> 
				</div>
